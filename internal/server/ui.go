...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Parcel</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Parcel</h1>
    <p>File sharing — upload a file, get a link, set an expiry. Self-hosted WeTransfer</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">10 files, 100MB total, 7-day expiry</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited files, 1GB, custom expiry</div>
